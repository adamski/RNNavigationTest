...
//==============================================================================
public class RNNavigationTest   extends Activity
{
    //==============================================================================
    static
    {
    ...
    public MidiDeviceManager getAndroidMidiDeviceManager()
    {
        ...
        synchronized (RNNavigationTest.class)
        {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            RNNavigationTest.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            RNNavigationTest.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            RNNavigationTest.this.alertDismissed (callback, 2);
                        }
                    })
